...
<body>
    ...
    <main>
        ...
        $strSQL="INSERT INTO usuario(id,nombre,email,contrasena,telefono)";

        $strSQL.="VALUES(0,'".$nombre."','".$email."','".$contrasena."','".$telefono."')";

        $r=mysqli_query($conn,$strSQL);

        if($r){
            echo '<center><div id="aviso"><span>Te has registrado correctamente</span><br><a href="../HTML/form-login.html">Iniciar sesión</a></div></center>';
        }else{
