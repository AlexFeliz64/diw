<?php require_once("..\PHP\libreria\conexion.php"); ?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <main>
        ...
        $strSQL="INSERT INTO contacto(id,nombre,email,asunto,mensaje)";

        $strSQL.="VALUES(0,'".$nombre."','".$email."','".$asunto."','".$mensaje."')";

        $r=mysqli_query($conn,$strSQL);

        if($r){
            echo '<center><div id="aviso"><span>Gracias por contactarnos</span><br>Nos importa tu opinión, si quieres enviar otro comentario haz click <a href="../HTML/form-contacto.html">aquí</a></div></center>';
        }else{
            echo '<center><div id="aviso"><span>Ha ocurrido un error inesperado</span><br>Nos importa tu opinión, si quieres enviar otro comentario haz click <a href="../HTML/form-contacto.html">aquí</a></div></center>';
        }
        }
        ?>
    </main>
